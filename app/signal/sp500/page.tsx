...
export default async function Sp500SignalPage() {
  let signal;
    ...
    <div className="min-h-screen">
      <main className="mx-auto max-w-4xl px-6 py-12">
        ...
        <div className="mt-6 flex items-start justify-between gap-4">
          <div>
            <p className="font-mono text-[10px] uppercase tracking-[0.25em] text-slate-400">S&amp;P 500 / リアルタイム</p>
            <h1 className="mt-1 text-2xl font-semibold tracking-tight text-[#e8f4ff]">S&amp;P 500 シグナル状態</h1>
        ...
        <section className="mt-8">
          <QuickRef
            ...
            relatedPages={[
              { label: "/signal — シグナル一覧",  href: "/signal",    note: "全銘柄のシグナル状態" },
