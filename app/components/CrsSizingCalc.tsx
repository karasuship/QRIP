...
export default function CrsSizingCalc({ crs }: Props) {
  ...
  return (
    <div className="mt-3 rounded-2xl border border-white/[0.22] bg-white/[0.11] p-4 backdrop-blur-md">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full rounded-xl border border-white/[0.15] bg-white/[0.11] py-2 pl-7 pr-3 font-mono text-sm text-[#e8f4ff] outline-none focus:border-white/30 [appearance:textfield] [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none"
          />
        </div>
      </div>

      <div className="mt-3 flex items-center justify-between rounded-xl border border-white/[0.09] bg-white/[0.14] px-4 py-3">
        <div>
      ...
      <p className="mt-2 font-mono text-[9px] text-slate-500 leading-4">
